...
| `form`, `textarea` | Registro de condición (W2) y notas de discrepancia (W3). |
| `alert-dialog` | Cancelar la suscripción (W5). **No** la baja de copia: pide un motivo, y `alertdialog` es para decidir, no para rellenar. |
