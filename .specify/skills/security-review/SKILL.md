...
2. **PII handling**: Do Google Calendar event titles contain only class type + level (no coachee/coach names)? Are coach financial fields marked for AES-256-GCM encryption?
