...
Monthly TBR (to-be-read) list persistence and API: get-or-create per calendar month, scheduled auto-creation, and add/remove book entries scoped per user (UC, KAN-10).
