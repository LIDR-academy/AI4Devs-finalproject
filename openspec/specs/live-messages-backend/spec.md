# Live Messages Backend

## Purpose
This specification defines the backend capabilities for the Live Messages feature, which allows event accomplices to send real-time WhatsApp updates to guests during an event.
