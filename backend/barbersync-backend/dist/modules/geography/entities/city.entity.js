...
__decorate([
    (0, typeorm_1.Column)({ type: 'uuid', name: 'region_id' }),
    __metadata("design:type", String)
], City.prototype, "region_id", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => region_entity_1.Region, (region) => region.cities, { onDelete: 'CASCADE' }),
...
exports.City = City = __decorate([
    ...
    (0, typeorm_1.Unique)(['name', 'region_id'])
], City);
