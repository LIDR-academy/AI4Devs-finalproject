...
from .routes.listing import register_routes as register_listing_routes
from .routes.deletion import register_routes as register_deletion_routes
...
register_listing_routes(files_bp)
register_deletion_routes(files_bp)
