...
> This skill governs **structure** ("where code lives and what may depend on what"). Product behavior lives in `openspec/`; code-level stack rules live in the two stack skills. Never encode business requirements here.
