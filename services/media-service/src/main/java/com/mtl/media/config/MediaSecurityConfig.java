        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers("/actuator/health", "/actuator/info", "/actuator/prometheus")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/media/public/ejemplares/*/primary-photo")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/media/ejemplares/*/photos")
                    .permitAll()
                    ...
                    .hasAnyRole("COLABORADOR", "ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/api/media/ejemplares/*/photos")
                    .hasAnyRole("COLABORADOR", "ADMIN")
