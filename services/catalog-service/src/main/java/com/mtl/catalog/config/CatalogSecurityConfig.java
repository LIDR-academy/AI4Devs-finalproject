        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers("/actuator/health", "/actuator/info", "/actuator/prometheus")
                    ...
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/catalog/ejemplares")
                    .hasAnyRole("COLABORADOR", "ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/catalog/ejemplares/*")
                    .hasAnyRole("COLABORADOR", "ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/catalog/ejemplares/*")
                    .hasAnyRole("COLABORADOR", "ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/api/catalog/ejemplares/*")
                    .hasAnyRole("COLABORADOR", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/catalog/ejemplares")
                    .hasAnyRole("COLABORADOR", "ADMIN")
                    .requestMatchers(
                        HttpMethod.GET, "/api/catalog/ejemplares/*/media-submission-permission")
                    .hasAnyRole("COLABORADOR", "ADMIN")
                    .anyRequest()
                    .authenticated())
        .exceptionHandling(
