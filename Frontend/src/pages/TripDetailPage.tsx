...
export function TripDetailPage() {
  ...
  const handleSettingsSuccess = (updatedTrip: TripResponse) => {
    ...
    queryClient.setQueryData(
      ['trip', id, { participantsPage: 1, participantsLimit: 20 }],
      updatedTrip,
    );
  };
              ...
              <div className="bg-white rounded-xl p-6 shadow-md space-y-4">
                ...
                {balancesError ? (
                  ...
                  <>
                    ...
                    {(() => {
                      const userBalance =
                        balances.balances.find(b => b.user_id === user?.id)?.balance ?? 0;
                      return (
                        <div
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      ...
                      <StatCard
                        ...
                        value={formatCurrency(balances.total_expenses ?? 0, trip_currency)}
                      />
                      <StatCard label="Participantes" value={balances.participant_count ?? 0} />
                    </div>
                  </>
                ) : (
