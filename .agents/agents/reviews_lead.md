...
- **`full`** — the complete review *after all slices are done*. Fan out **all six** reviewers, coupled with mutation (the lead re-runs mutation alongside each round).
