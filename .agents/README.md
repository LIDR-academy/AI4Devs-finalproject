...
*   **[Pipeline QA Completo SOTA v2.1](workflows/06_full_qa_pipeline.md):** Pipeline QA completo con Stryker Mutation Score >= 70% y veredicto JSON Schema.
...
*   **01_product_definition:** [SK-01 Descubrimiento de Producto](skills/specs/01_product_definition/SK-01_product_discovery.md) y [SK-02 Generación del PRD](skills/specs/01_product_definition/SK-02_prd_generation.md).
*   **02_architecture_design:** [SK-03 Modelo de Dominio](skills/specs/02_architecture_design/SK-03_domain_model.md), [SK-04 Diseño Técnico](skills/specs/02_architecture_design/SK-04_technical_design.md) y [SK-05 Asistente de Diseño UI/UX](skills/specs/02_architecture_design/SK-05_ui_ux_design.md).
*   **03_persistence_and_api:** [SK-06 Esquema de Base de Datos](skills/specs/03_persistence_and_api/SK-06_database_schema.md) y [SK-07 Especificación API REST](skills/specs/03_persistence_and_api/SK-07_api_specification.md).
*   **04_governance_and_quality:** [SK-08 Estrategia de Seguridad](skills/specs/04_governance_and_quality/SK-08_security_strategy.md), [SK-09 Estrategia de Pruebas](skills/specs/04_governance_and_quality/SK-09_testing_strategy.md) y [SK-10 Pipeline CI/CD](skills/specs/04_governance_and_quality/SK-10_cicd_pipeline.md).
*   **05_agile_planning:** [SK-11 Historias de Usuario (INVEST)](skills/specs/05_agile_planning/SK-11_user_stories.md), [SK-12 Planificación de Tickets](skills/specs/05_agile_planning/SK-12_backlog_tickets.md), [SK-13 Matriz de Trazabilidad](skills/specs/05_agile_planning/SK-13_traceability_matrix.md), [SK-14 Mapa del Backlog](skills/specs/05_agile_planning/SK-14_backlog_map.md) y [SK-15 Registro de PRs](skills/specs/05_agile_planning/SK-15_pull_requests.md).

### Fase de Codificación (Development)
*   **01_rules_extraction:** [SK-15 Extracción de Reglas Legacy](skills/development/01_rules_extraction/SK-15_extract_rules.md).
*   **02_backend_development:** [SK-16 Desarrollo Backend & Entidades Secundarias](skills/development/02_backend_development/SK-16_backend_ticket.md).
*   **03_frontend_development:** [SK-17 Desarrollo Frontend & Touch UI](skills/development/03_frontend_development/SK-17_frontend_ticket.md).
*   **04_persistence_and_db:** [SK-18 Migraciones, Seeds & Anti-Orfandad](skills/development/04_persistence_and_db/SK-18_db_migration.md).
*   **05_quality_and_lint:** [SK-19 Refactor & Anti-N+1 / Anti-Mass-Assignment](skills/development/05_quality_and_lint/SK-19_refactor_lint.md), [SK-22 DBA Log Analysis & Troubleshooting](skills/development/05_quality_and_lint/SK-22_agent_troubleshooting.md), [SK-23 Seguridad en Dependencias Anti-Slopsquatting](skills/development/05_quality_and_lint/SK-23_dependency_security_guard.md), [SK-24 Characterization Testing](skills/development/05_quality_and_lint/SK-24_characterization_testing.md) y [SK-26 Recuperador Dinámico Few-Shot](skills/development/05_quality_and_lint/SK-26_few_shot_retriever.md).
*   **06_visual_qa:** [SK-20 Browser Visual QA](skills/development/06_visual_qa/SK-20_browser_qa.md) y [SK-21 Auditoría Accesibilidad UI/a11y](skills/development/06_visual_qa/SK-21_ui_accessibility_auditor.md).
