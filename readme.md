...
app/
  ...
  Livewire/           Componentes Livewire, agrupados por área (Settings/, Users/, Roles/, SalesRegions/, Actions/...)
  Models/             Modelos Eloquent (User, SalesRegion; Role, subclase del modelo de rol del paquete)
  Notifications/      Notificaciones (PendingEmailVerification, UserInvitation)
  Policies/           Policies de modelo (UserPolicy, RolePolicy, SalesRegionPolicy), autodescubiertas por nombre
...
> El dominio de ecommerce del PRD está implementado en base de datos **solo en su primera pieza**: además de autenticación, autorización y ciclo de vida de la cuenta (`users.status`, `users.pending_email`, `users.deleted_at`), existe ya `sales_regions`, el catálogo de regiones fiscales de la Epic 2 — la primera tabla de dominio del proyecto y la primera creada de cero con PK UUID v7. Productos, variantes, pedidos, blog y envíos siguen sin existir en base de datos. Este diagrama se ampliará conforme se construyan esos módulos.
