...
// bespoke login code -- Fortify's login pipeline resolves the user via a
// plain User::where('email', ...) lookup, which the global scope excludes
// a trashed row from once SoftDeletes lands on the model.
