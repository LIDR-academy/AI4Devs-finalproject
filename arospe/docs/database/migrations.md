...
_Last updated: 2026-09-05 — Collapsed the accumulating `_Previously:` footer chain (spanning tasks 0003–story 0029, ~5.3k characters) into this single line, per the doc-growth-management rule now codified in [contracts.md](../contracts.md#doc-growth-management-rule) and the docs-maintainer skill's Definition of Done. No convention content changed this pass.
