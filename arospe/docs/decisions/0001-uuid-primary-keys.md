...
_Last updated: 2026-09-06 — Story 0032 (Shipping geography catalog seed): added **Amendment 5**, recording `geography_entries` as the first real instance of the `bigint` exception Amendment 1 named in the abstract on 2026-08-27. No rule changed; no prior amendment was corrected._
