...
> natural fit is Epic 2's [0022](in-progress/0022-searchable-multi-select-component.md) (shared searchable,
...
either**, and the natural fit — Epic 2's [0022](in-progress/0022-searchable-multi-select-component.md), the shared
...
[0022](in-progress/0022-searchable-multi-select-component.md) (the shared searchable multi-select) is `new` and has
...
1. **Replace the interim product picker with story [0022](in-progress/0022-searchable-multi-select-component.md)'s
...
- **Epic 3 decomposition:** story **15 of 15** — the last, and the only one that consumes rather than
  ...
  a documented **soft** dependency on Epic 2's pending [0022](in-progress/0022-searchable-multi-select-component.md),
