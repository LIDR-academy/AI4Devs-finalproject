...
This story is the blog mirror image of [0023 (product-categories-backend)](0023-product-categories-backend.md),
...
> [0023](0023-product-categories-backend.md) applied to product categories, whose guard 0024 owns.
...
Decisions **D-1**…**D-12** correspond one-for-one to [0023](0023-product-categories-backend.md)'s, so
...
- **D-4 — Uniqueness is enforced on a stored `normalized_name` column carrying the `UNIQUE` index —
  ...
  **Discrepancy recorded, not acted on:** [0023](0023-product-categories-backend.md)
