...
| `resources/views/layouts/app/sidebar.blade.php` | **Modify** — one `flux:sidebar.item`. **Branch on whether [0013](0013-sidebar-module-gating-ui.md) has landed** — see **D-8**, and **OQ-1** for the placement question. |
...
- **D-8 — Sidebar entry branches on whether [0013](0013-sidebar-module-gating-ui.md) has landed**, exactly
...
- Optional interaction: **[0013](0013-sidebar-module-gating-ui.md)** changes *which file* the sidebar
