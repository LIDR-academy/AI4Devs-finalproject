...
*Rejected:* [0022](0022-searchable-multi-select-component.md)'s searchable multi-select, on three
...
- *Rejected:* [0022](0022-searchable-multi-select-component.md)'s searchable multi-select, on **D-2**'s
