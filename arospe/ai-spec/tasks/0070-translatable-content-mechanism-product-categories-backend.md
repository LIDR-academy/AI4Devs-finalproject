...
- **[Story 0023](0023-product-categories-backend.md)** — hard dependency, and **not yet implemented**. This story retrofits its table, its model, its validation trait and two of its three actions. See **R-1** and **R-3**.
