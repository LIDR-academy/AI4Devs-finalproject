...
[0022](in-progress/0022-searchable-multi-select-component.md)).
...
- [ ] Typing `España` in the region picker narrows the live dropdown to Spain's fiscal sub-entries
      ...
      [0022](in-progress/0022-searchable-multi-select-component.md)'s own provenance note: 0022 proves the
...
[0022](in-progress/0022-searchable-multi-select-component.md), [0023](0023-product-categories-backend.md),
