...
> **Split out of story [0015](0015-harden-users-crud-security-posture.md) on 2026-08-23**, following
...
- **Creating a user is not step-up-gated.** Q2 named role/status changes and deletion only. Creation
  ...
  story [0015](0015-harden-users-crud-security-posture.md)'s F6. Recorded as a decision so a future
...
- **Split from story [0015 — Harden the Users CRUD backend's security posture](0015-harden-users-crud-security-posture.md)**
...
into story [0015](0015-harden-users-crud-security-posture.md) as one of ten consolidated non-blocking
