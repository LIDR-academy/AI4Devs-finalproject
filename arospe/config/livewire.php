...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Story 0019 Phase 4 finding F-5 (Low): Livewire's own unrestricted default
        // (['required', 'file', 'max:12288'] -- 12 MB, no mimes check) let anyone holding just
        // media.view stage an arbitrary file type at a looser size ceiling than this app's own
        // rules enforce, reachable before App\Livewire\Media\Gallery::upload() ever runs its own
        // validation. This mirrors App\Concerns\MediaValidationRules::imageUploadRules() (a
        // literal here, not a class-constant reference, to keep this vendor-published config file
        // free of a coupling to an app class -- if MAX_UPLOAD_KB ever changes, update this too).
        'rules' => ['required', 'file', 'mimes:jpg,jpeg,png', 'max:8192'],
        'directory' => null,                                  // Example: 'tmp'                     | Default: 'livewire-tmp'
        'middleware' => null,                                 // Example: 'throttle:5,1'            | Default: 'throttle:60,1'
        // Story 0019 Phase 4 re-audit finding N-7 (Low, tidy-up): trimmed from the vendor
        // default's full media-type list (svg, mp4, wav, mp3, ...) to exactly this app's own
        // three accepted extensions. None of the trimmed types could ever reach this step --
        // 'rules' above already refuses anything but jpg/jpeg/png before a file is staged -- so
        // this was dead weight rather than a live vector, tidied while already in this file.
