...
class Pet < ApplicationRecord
  ...
  def next_vaccination_due
    vaccinations.upcoming.order(:next_due_date).first&.next_due_date
  end
  
  def upcoming_vaccinations
    vaccinations.upcoming.order(:next_due_date)
  end
  
  def overdue_vaccinations
    vaccinations.overdue.order(:next_due_date)
  end
  
  def vaccinations_due_soon
    vaccinations.due_soon.order(:next_due_date)
  end
