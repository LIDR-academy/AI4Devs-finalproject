...
namespace ConsultCore31.Tests.Controllers
{
    ...
    public class PuestosControllerTests
    {
        ...
        public async Task GetAll_DebeRetornarOkConListaDePuestos()
        {
            ...
            {
                new PuestoDto { Id = 1, Nombre = "Gerente", Descripcion = "Gerente de departamento", Nivel = 1, FechaCreacion = DateTime.UtcNow },
                new PuestoDto { Id = 2, Nombre = "Analista", Descripcion = "Analista de sistemas", Nivel = 3, FechaCreacion = DateTime.UtcNow }
            };
