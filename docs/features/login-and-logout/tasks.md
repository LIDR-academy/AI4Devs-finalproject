...
|---|---|---|---|---|
| [task-1](./task-1.md) — AuthDao (Supabase auth) | 1 | @s2,@s4 | done | libs/supabase-services/src/dao/auth.dao.ts |
| [task-2](./task-2.md) — AuthService (sign-in/out + validators) | 1 | @s2,@s4,@s9 | done | libs/supabase-services/src/services/auth.service.ts |
...
| [task-6](./task-6.md) — Auth error contract (normalization + type) | 2 | @s5,@s6 | done | libs/supabase-services/src/services/auth.service.ts, libs/types/src/auth-error.ts |
