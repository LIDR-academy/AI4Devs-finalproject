...
| [task-6](./task-6.md) | 3 | @s9 | done | libs/localization/src/resources/{en,es,pt,de}.ts, libs/activities/src/organisms/flashcard/flashcard.tsx |
| [task-7](./task-7.md) | 3 | @s10 | done | libs/activities/src/organisms/flashcard/flashcard.tsx, use-flashcard.ts |
| [task-8](./task-8.md) | 3 | @s1,@s2,@s3,@s4,@s7,@s8 | done | libs/activities/src/organisms/flashcard/flashcard.stories.tsx |
| [task-9](./task-9.md) | 3 | @s1,@s2,@s3,@s4,@s5 | done | libs/activities/tests/e2e/organisms/flashcard/flashcard.e2e.js |
