...
| [task-4](./task-4.md) — `PdfUploadDao` (storage upload + function invoke) | 1 | @s1,@s4 | done | libs/supabase-services/src/dao/pdf-upload.dao.ts |
| [task-5](./task-5.md) — `PdfExtractionService` (validate + orchestrate) | 1 | @s1,@s4 | done | libs/supabase-services/src/services/pdf-extraction.service.ts |
...
| [task-9](./task-9.md) — Server error contract + scanned/page/corrupt detection | 2 | @s8,@s11,@s12,@s14 | done | supabase/functions/extract-pdf/, libs/supabase-services/src/services/pdf-extraction.service.ts |
| [task-10](./task-10.md) — Client pre-validation (type + size) | 2 | @s9,@s10 | done | libs/supabase-services/src/services/pdf-extraction.service.ts |
...
| [task-15](./task-15.md) — Extraction analytics events | 3 | @s17 | done | libs/supabase-services/src/services/pdf-extraction.service.ts, libs/study-buddy/src/components/pdf-upload/ |
