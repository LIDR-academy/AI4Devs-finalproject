...
scenarios: [s1, s4]
status: done
paths: [libs/supabase-services/src/services/pdf-extraction.service.ts, libs/supabase-services/src/services/index.ts]
---
...
- [x] Exported through `libs/supabase-services/src/services/index.ts`.
...
## Notes
- Mirror `libs/supabase-services/src/services/auth.service.ts` shape (static abstract class, typed returns).
