...
## Done criteria
- [x] Stories cover `@s1`, `@s7`, `@s8`, `@s9`, `@s10`, `@s13`, `@s14`
- [x] Story titles/args mirror the `MultipleChoice` stories structure (`Organisms/Matching`)
- [x] Interactive story drives the select→pair→submit→feedback flow for the e2e
