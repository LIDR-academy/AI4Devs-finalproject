...
## Done criteria
- [x] E2E cases cover `@s2`, `@s3`, `@s6`, `@s7`, `@s8`, `@s9`, `@s10`
- [x] Runs green: `pnpm --filter @helsoft/activities test:e2e` against the Storybook build
- [x] Selectors/interaction live in the test (contract stays declarative)
- [x] No flakiness (await rendered state transitions, not timeouts)
