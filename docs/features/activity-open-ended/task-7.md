...
## Done criteria
- [x] `@s9` covered by unit tests: input name, Submit target size, reveal announcement, locked state for AT
- [x] Reveal announced once on submit (no duplicate-announcement regression)
