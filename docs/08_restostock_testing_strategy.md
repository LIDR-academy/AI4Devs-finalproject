# 🧪 Estrategia de Testing y Directivas TDD de RestoStock

Este documento define la política estricta de control de calidad, aseguramiento de software y la directiva innegociable de **Desarrollo Guiado por Pruebas (Test-Driven Development - TDD)** para el proyecto RestoStock. Estas directrices aplican tanto para desarrolladores humanos como para agentes de codificación basados en Inteligencia Artificial.
