...
Este documento representa visualmente la trazabilidad del proyecto, vinculando los temas del Roadmap, los módulos (Vertical Slices / Epics), las Historias de Usuario (US) y los Tickets Técnicos de desarrollo (divididos en Backend y Frontend).
