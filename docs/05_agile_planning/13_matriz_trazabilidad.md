...
| **REQ-020** | `auth` | `User` | `POST /api/v1/auth/forgot-pin`, `POST /api/v1/auth/reset-pin` | [US-018](11_user_stories/auth/US-018.md) | [TK-077](12_tickets/auth/backend/TK-077.md) | [TK-077-FE](12_tickets/auth/frontend/TK-077-FE.md) | 📋 Approved Spec | [SK-12_generate_backlog_tickets.md](../../.agents/skills/specs/05_agile_planning/SK-12_generate_backlog_tickets.md) |
