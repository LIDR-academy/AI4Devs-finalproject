...
| **📖 Catálogo / Recetas (`catalog`/`recipes`)** | [US-037: Edición y Baja de una Receta del Recetario](11_user_stories/catalog/US-037_edicion_baja_receta.md) — [AUDIT-DEV-012](../audits/AUDIT-DEV-012-ai-config-leakage-and-crud-coverage.md) C-2 | [TK-131: PUT / DELETE /api/v1/recipes/:id](12_tickets/recipes/backend/TK-131.md) | [TK-131-FE: Edición y Baja de Recetas en el Recetario](12_tickets/recipes/frontend/TK-131-FE.md) | 🏗️ Backend Done · FE pendiente |
