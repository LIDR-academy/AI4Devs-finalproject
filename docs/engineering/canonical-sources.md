...
| Alta REST catálogo (`POST /api/catalog/ejemplares`), `usuario_app`, auditoría R3 | [docs/adr/0004-catalog-rest-write-and-audit.md](../adr/0004-catalog-rest-write-and-audit.md) | Enlace en `spring-boot-4-backend` y `backend-generation-standard` |
