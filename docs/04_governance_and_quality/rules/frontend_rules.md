...
* **Foco visible (SC 2.4.7 / 2.4.11):** Todo elemento interactivo muestra un `:focus-visible` con contraste ≥ 3:1, y ningún elemento fijo (topbar, toast) lo obstruye al tabular.
