...
## Story
**As a** desarrollador junior/mid-level que necesita contexto técnico rápido,  
**I want** un agente especializado que entienda código y proporcione contexto empresarial,  
**so that** pueda ser productivo sin sobrecargar mentores senior con consultas repetitivas
